...
param(
    [string]$TaskName = "Ozon_Placement_Retry",
...
$jobScript = Join-Path $root "scripts\run_ozon_placement_retry.cmd"
$hiddenRunner = Join-Path $root "scripts\run_hidden.vbs"
$venvPython = Join-Path $root ".venv\Scripts\python.exe"
$jobFile = Join-Path $root "app\jobs\job_ozon_placement_retry.py"
...
$description = "DataBase_MP: smart retry for Ozon placement if morning report was empty and Sheets used an older report."
