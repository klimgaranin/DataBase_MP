...
param(
    [string]$TaskName = "Ozon_Product_Cards_Sync",
...
$jobScript = Join-Path $root "scripts\run_ozon_product_cards.cmd"
$hiddenRunner = Join-Path $root "scripts\run_hidden.vbs"
$venvPython = Join-Path $root ".venv\Scripts\python.exe"
$jobFile = Join-Path $root "app\jobs\job_ozon_product_cards.py"
...
$startAt = (Get-Date -Hour 0 -Minute 25 -Second 0)
...
$description = "DataBase_MP: Ozon product cards hourly sync. Loads official photos from Seller API."
