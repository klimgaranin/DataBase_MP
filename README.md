...
Из файла списка заказов читаются:

- лист `КНР` — текущий блок заказов в производстве/пути;
- листы `1-для заполнения` и `2-пришло` — артикул, спецификация и дата
  производства для будущей выгрузки в Google Sheets.
...
- `staging.supply_order_specs_current` — спецификации и даты производства из
  листов `1-для заполнения` и `2-пришло`.
